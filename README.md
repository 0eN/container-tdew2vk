...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-tdew2vk.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-tdew2vk.containers.anotherwebservice.com/
...
```
git clone git@github.com:0eN/container-tdew2vk.git
cd container-tdew2vk
```
...
```
docker attach container-tdew2vk
```
